...
class graphicDesignService extends StatefulWidget {

  @override
  _graphicDesignServiceState createState() => _graphicDesignServiceState();
}

class _graphicDesignServiceState extends State<graphicDesignService> {

  final _formKey = GlobalKey<FormState>();
  String email, name, surname, phoneNumber, time, serviceDesc;
  String types = "Graphic Design";
  bool remember = false;
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("Graphic Design Services", style: headingStyle, textAlign: TextAlign.center,),
                  Text(
                    "Please fill in all your details to apply for Graphic Design assistance",
                  ...
                  SizedBox(height: SizeConfig.screenHeight * 0.04),
                      ...
                      DefaultButton(
                        ...
                        press: () async {
                          ...
                          userGraphicDesignServiceHome(name, surname, phoneNumber, time, serviceDesc, email);
                          ...
                          sendEmail(name: name, surname: surname, phoneNumber: phoneNumber, time: time, serviceDesc: serviceDesc, types: types, email: email );
  ...
  Future sendEmail({name, surname, phoneNumber, time, serviceDesc, types, email}) async {
  ...
  TextFormField buildTimeField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintText: "Enter Time Limit Expectation",
        // If  you are using latest version of flutter then lable text and hint text shown like this
        // if you r using flutter less then 1.20.* then maybe this is not working properly
        floatingLabelBehavior: FloatingLabelBehavior.always,
  ...
  // Graphic Description Description Input Field
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: "Graphic Design Description",
        hintText: "Enter Reason for Graphic Design Assistance",
