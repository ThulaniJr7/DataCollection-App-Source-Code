...
class marketingService extends StatefulWidget {

  @override
  _marketingServiceState createState() => _marketingServiceState();
}

class _marketingServiceState extends State<marketingService> {

  final _formKey = GlobalKey<FormState>();
  String email, name, surname, phoneNumber, amount, serviceDesc;
  String types = "Marketing";
  bool remember = false;
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("Marketing Services", style: headingStyle, textAlign: TextAlign.center,),
                  Text(
                    "Please fill in all your details to apply for Marketing assistance",
                  ...
                  SizedBox(height: SizeConfig.screenHeight * 0.04),
                      ...
                      DefaultButton(
                        ...
                        press: () async {
                          ...
                          userMarketingServiceHome(name, surname, phoneNumber, serviceDesc, email);
  ...
  // Marketing Description Input Field
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: "Marketing Description",
        hintText: "Enter Reason for Marketing Assistance",
