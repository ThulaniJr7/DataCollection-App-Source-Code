...
class financeService extends StatefulWidget {

  @override
  _financeServiceState createState() => _financeServiceState();
}

class _financeServiceState extends State<financeService> {

  final _formKey = GlobalKey<FormState>();
  String email, name, surname, phoneNumber, amount, serviceDesc;
  String types = "Finance";
  bool remember = false;
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("Financial Services", style: headingStyle, textAlign: TextAlign.center,),
                  Text(
                    "Please fill in all your details to apply for Financial assistance",
                  ...
                  SizedBox(height: SizeConfig.screenHeight * 0.04),
                      ...
                      DefaultButton(
                        ...
                        press: () async {
                          ...
                          userFinanceServiceHome(name, surname, phoneNumber, amount, serviceDesc, email);
                          ...
                          sendEmail(name: name, surname: surname, phoneNumber: phoneNumber, amount: amount, serviceDesc: serviceDesc, types: types, email: email );
  ...
  Future sendEmail({name, surname, phoneNumber, amount, serviceDesc, types, email}) async {
  ...
  // Finance Description Input Field
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: "Finance Description",
        hintText: "Enter Reason for Financial Assistance",
