...
class RegStokvel extends StatefulWidget {
  @override
  _RegStokvelState createState() => _RegStokvelState();
}

class _RegStokvelState extends State<RegStokvel> {
                  ...
                  child: Container(
                    ...
                    child: FlatButton(
                      onPressed: () {
                        ...
                        final String contactPersonName = contactPersonNameController.text.toString();
                        ...
                        if (email.isEmpty) {
                          ...
                          if (password.isEmpty) {
                            ...
                            context.read<AuthService>().userRegistrationStokvel(
                              email, password,
                            ).then((value) async {
                              User user = FirebaseAuth.instance.currentUser;

                              await FirebaseFirestore.instance.collection(
                                  "stokvelRegUser").doc(user.uid).set({
                                'uid': user.uid,
                                'email': email,
                                'password': password,
                              });
