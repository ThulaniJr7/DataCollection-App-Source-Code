...
{
  // Need to figure out how the Route Name works
...
class _registrationDCState extends State<registrationDC> {
  ...
  final String userRole = "DC";
  String types = "Distribution Center";
  bool remember = false;
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("Register As A Distribution Center", style: headingStyle, textAlign: TextAlign.center,),
                  // Text(
                                ...
                                if(password == conform_password)
                                {
                                  ...
                                  if(password.length > 7 && conform_password.length > 7)
                                  {
                                    ...
                                    if(businessName != null && contactPerson != null && contactPersonNumber != null && contactPersonPosition != null && bizAdd1 != null && bizAdd2 != null && township != null && postalCode != null && companyRegNum != null)
                                    {
                                      ...
                                      userDistroCentSetup(businessName, value, bizAdd1, bizAdd2, township, postalCode, companyRegNum, contactPerson, contactPersonPosition, contactPersonNumber, userRole, email, conform_password);
